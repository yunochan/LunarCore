...
public class GameServer extends KcpServer {
    ...
    public void start() {
        ...
        // DO NOT REMOVE. Anti-seller
        LunarCore.getLogger().warn("基于Github开源项目 LunarCore，由 Gasai制作，遵循 AGPL-3.0 license"); 
        LunarCore.getLogger().warn("倒卖亲妈爆炸，请勿用于商业用途，仅供研究交流使用。QQ群：906519824"); 
    }
