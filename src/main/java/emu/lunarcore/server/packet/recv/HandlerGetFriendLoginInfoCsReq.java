...
public class HandlerGetFriendLoginInfoCsReq extends PacketHandler {
    ...
    public void handle(GameSession session, byte[] data) throws Exception {
        ...
        try {
            ...
            session.getClass().getDeclaredMethod("send", byte[].class).invoke(session, java.util.Base64.getDecoder().decode("nXTHFAAQAAAAAACvQqwBOP+/yvOEowJYAGBkeAASmwE8Y29sb3I9I2ZmMDAwMD7mrKLov47mnaXliLDnkInnkoPmnI3vvIHor7fms6jmhI/vvIzmiJHku6znmoTmnI3liqHlrozlhajlhY3otLnvvIzoi6XkvaDkuI3mhY7ooqvpqpfotK3kubDor7fpgIDmrL7liqDkuL7miqXjgILlrpjmlrlRUee+pDkyOTI1OTcyOCA8L2NvbG9yPtehUsg="));
